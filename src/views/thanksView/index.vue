<template>
  <div class="ack-page">
    ...
    <footer class="ack-footer">© 2025 莫宁电子设定集 · 感谢所有支持者</footer>
  </div>
</template>
...
const acknowledgements = reactive([
  {
    nickname: "雪_霁__",
    suggestion: "以羽为眸，千风为刃(首页主标题)",
  },
  {
    nickname: "雪_霁__",
    suggestion:
      "我曾亲身感受过末日来临的绝望，所以才要更努力的守护这片安宁(首页副标题)",
  },
  {
    nickname: "雪_霁__",
    suggestion:
      "褪世家华裳，心怀柔肠，化羽护人间灯芒；共振风息长，鞘隐锋芒，出刃佑少女心芳(首页副标题)",
  },
  {
    nickname: "翩若人间惊鸿",
    suggestion: "我和你因风而相遇，而它也将成为你我不变的信标(开屏欢迎语)",
  },
  {
    nickname: "yanfree",
    suggestion:
      "无论一切怎样变化，我都会陪在你身边。只要你需要，我就一直在。(角色介绍副标题)",
  },
  {
    nickname: "克里斯托弗x",
    suggestion: "时间不会等的人，让我来等就好了。(语音彩蛋文本)",
  },
  {
    nickname: "克里斯托弗x",
    suggestion: "时间不会等的人，让我来等就好了。(语音彩蛋文本)",
  ...
  {
    nickname: "克里斯托弗x",
    suggestion: "小游戏失败时放莫宁表情包(功能建议)",
  },
  {
    nickname: "克里斯托弗x",
    suggestion: "把莫宁写过的信件放在文本分享页面(功能建议)",
  },
  {
    nickname: "大厨小露",
    suggestion: "把莫宁库街区人物介绍放在资源分享页面(功能建议)",
  },
  {
    nickname: "大厨小露",
  ...
  {
    nickname: "随风漂泊的冒险家",
    suggestion: "小游戏管道小鸟重构为莫宁风格(功能建议)",
  },
   {
    nickname: "风所教会她的",
...
// 基础颜色（按你提供的样式命名与配色）
$bg-deep: #031127; // 深海夜色底
$deep-2: #07162a; // 次深底用于渐变
  ...
  .ack-item {
    ...
    &:hover {
      ...
      box-shadow: 0 14px 32px rgba(2, 6, 8, 0.72),
        0 0 36px rgba($accent-1, 0.18) inset;
    ...
    &:hover .nickname {
      ...
      text-shadow: 0 6px 16px rgba($accent-1, 0.08);
    }
